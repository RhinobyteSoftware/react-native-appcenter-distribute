// Copied from: https://github.com/Microsoft/AppCenter-SDK-Android/blob/develop/sdk/appcenter-distribute/src/main/java/com/microsoft/appcenter/distribute/CheckDownloadTask.java
// Raw: https://raw.githubusercontent.com/Microsoft/AppCenter-SDK-Android/develop/sdk/appcenter-distribute/src/main/java/com/microsoft/appcenter/distribute/CheckDownloadTask.java
...
class CheckDownloadTask extends AsyncTask<Void, Void, DownloadProgress> {
    ...
    protected DownloadProgress doInBackground(Void... params) {
        ...
        CustomizedDistributeService distribute = CustomizedDistributeService.getInstance();
    ...
    protected void onPostExecute(final DownloadProgress result) {
        if (result != null) {
            ...
            HandlerUtils.runOnUiThread(new Runnable() {
                ...
                @Override
                public void run() {
                    CustomizedDistributeService.getInstance().updateProgressDialog(mReleaseDetails, result);
                }
            });
        }
    }
