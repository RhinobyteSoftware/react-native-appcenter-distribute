// Copied from: https://github.com/Microsoft/AppCenter-SDK-Android/blob/develop/sdk/appcenter-distribute/src/main/java/com/microsoft/appcenter/distribute/DistributeUtils.java
// Raw: https://raw.githubusercontent.com/Microsoft/AppCenter-SDK-Android/develop/sdk/appcenter-distribute/src/main/java/com/microsoft/appcenter/distribute/DistributeUtils.java
...
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.INVALID_DOWNLOAD_IDENTIFIER;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.LOG_TAG;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_ENABLE_UPDATE_SETUP_FAILURE_REDIRECT_KEY;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_INSTALL_ID;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_PLATFORM;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_PLATFORM_VALUE;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_REDIRECT_ID;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_REDIRECT_SCHEME;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_RELEASE_HASH;
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.PARAMETER_REQUEST_ID;
...
import static com.rhinobyte.reactnative.appcenterdistribute.DistributeConstants.UPDATE_SETUP_PATH_FORMAT;
...
class DistributeUtils {
    ...
    static int getNotificationId() {
        return CustomizedDistributeService.class.getName().hashCode();
    }
    ...
    static void updateSetupUsingBrowser(Activity activity, String installUrl, String appSecret, PackageInfo packageInfo) {
        ...
        if (!NetworkStateHelper.getSharedInstance(activity).isNetworkConnected()) {
            ...
            CustomizedDistributeService.getInstance().completeWorkflow();
            return;
        }
